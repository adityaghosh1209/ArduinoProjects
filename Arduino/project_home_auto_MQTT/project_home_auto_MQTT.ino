/*
Home Auto Aditya ghosh 's project
...
//SH1106Wire display(0x3c, D2, D1);  // OLDED display
...
//  wifiManager.setSTAStaticIPConfig(IPAddress(10,0,1,99), IPAddress(10,0,1,1), IPAddress(255,255,255,0));
  ...
  //wifiManager.resetSettings();                                               resets the thing gg
 ...
 Serial.println("local ip");
 Serial.println(mqtt_server);//re print
}
...
void setup() //setup routine, runs once when system turned on or reset
{
 ...
 if (!mcp.begin())
  ...
  digitalWrite(D5, HIGH);
  display.clear();
    display.println("Setup's complete");
  // Draw it to the internal screen buffer
  display.drawLogBuffer(0, 40);
...
Serial.println("ppm");
    ...
    Serial.print("Publish message: ");//all of these Serial prints are to help with debuging
    // ======================================================== publish TDS 2 =============================
    client.publish("Tds1_value", temp);
    //=================================end convert======================================================
...
Serial.println("ppm");
    ...
    Serial.print("Publish message: ");//all of these Serial prints are to help with debuging
    // ======================================================== publish TDS 2 =============================
    client.publish("Tds2_value", temp);
    //=================================end convert======================================================
