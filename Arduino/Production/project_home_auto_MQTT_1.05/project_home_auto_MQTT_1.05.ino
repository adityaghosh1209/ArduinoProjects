...
display.clear();
        ...
        display.fillRect(2/*x start*/,2/*y start*/,126/*width*/,8/*width*/,WHITE/*colour*/);//draws a bar on top      
        display.setTextSize(1);//text size
        display.setTextColor(BLACK);//text colour (black or white)
        ...
        display.fillRect(2/*x start*/,56/*y start*/,126/*width*/,62/*hieght*/,WHITE/*colour*/);//draws a bar on bottom
        ...
        display.drawRect(2/*x start*/,13/*y start*/,25/*width*/,8/*hieght*/,WHITE/*colour*/);//draws the border for first rectancle(upper left side)
        display.fillRect(2/*x start*/,13/*y start*/,15/*width*/,8/*hieght*/,WHITE/*colour*/);//draws the fill (progress bar) rectangle on the border rectangle
        display.setTextSize(1);
        ...
        display.drawRect(75/*x start*/,13/*y start*/,25/*width*/,8/*hieght*/,WHITE/*colour*/);//draws the border for the second one(upper right)
        display.fillRect(75/*x start*/,13/*y start*/,15/*width*/,8/*hieght*/,WHITE/*colour*/);//draws the fill for the second one
        display.setCursor(75, 23);//places cursor below
        display.println("tank 2");//label
        display.setCursor(103, 13);//places cursor beside
        display.println("50%");//label
        display.drawRoundRect(2/*x start*/,34/*y start*/,25/*width*/,6/*hieght*/,8,WHITE/*colour*/);//draws the border for the third one(lower bottom)
        display.fillRoundRect(2/*x start*/,34/*y start*/,15/*width*/,6/*hieght*/,8,WHITE/*colour*/);//draws the fill
        display.fillCircle(30, 36, 4,WHITE);
        display.setCursor(39, 34);//places cursor beside
        display.println("24 C");//label
        display.setCursor(2, 45);//places cursor below
        display.println("Temp");//label
        display.setCursor(103, 13);//places cursor beside
        display.println("50%");//label
        //display.drawRect(75/*x start*/,33/*y start*/,25/*width*/,10/*hieght*/,WHITE/*colour*/);//draws the border
        display.drawRoundRect(75/*x start*/,33/*y start*/,25/*width*/,8/*hieght*/,8,WHITE/*colour*/);
        display.fillRoundRect(90/*x start*/,33/*y start*/,10/*width*/,8/*hieght*/,8,WHITE/*colour*/);
        //display.fillRect(85/*x start*/,33/*y start*/,10/*width*/,10/*hieght*/,8, WHITE/*colour*/);//draws the fill
        display.setCursor(103, 33);//places cursor below
        display.println("ON");//label
        display.setCursor(75, 45);//places cursor below
        display.println("Pump");//label
