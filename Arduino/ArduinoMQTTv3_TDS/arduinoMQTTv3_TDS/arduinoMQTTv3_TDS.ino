...
//================================ extender sensor headers and variables==========================
...
int getMedianNum(int bArray[], int iFilterLen) // get the appropriate TDS sensor reading
{
  int bTab[iFilterLen];
...
void loop() {
 ...
 // ================================================= end read tds values =========================================================================
  ...
  if (now - lastMsg > 2000) {
    ...
    //Serial.println(msg);
    // Serial.print("ppm ");
  //=========================== convert float to string and publish to mqtt =============================
    ...
    // ======================================================== publish TDS 1 =============================
    client.publish("TDS_value_1", temp);
    ...
    Serial.print("Publish message: ");//all of these Serial prints are to help with debuging
    // ======================================================== publish TDS 2 =============================
    client.publish("TDS value 1", temp);
    */
